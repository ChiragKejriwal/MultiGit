...
const  Login =()=>{
    ...
    const {user,loading,handleLogin,authError,setAuthError,}= useAuth();
  ...
  return (
    <main className="auth-page">
      <section className="auth-shell">
        ...
        <h1 className="auth-title">Sign in to MultiGit</h1>
        {(error || authError) && (
        ...
        <form className="auth-card" aria-label="Sign in form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="auth-field-group">
            <div className="auth-label-row">
              ...
              <span className="auth-helper-link">Forgot password?</span>
            </div>
            <input
              id="login-password"
              type="password"
        ...
        <section className="auth-footer-card auth-footer-card-inline">
          <span>New to MultiGit?</span> <Link to="/register" className="auth-footer-link">Create an account</Link>
        </section>
      </section>
    </main>
  )
